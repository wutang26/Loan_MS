         ...
         public function approvedLoans()
            {
                ...
                //Updating Status Controller
                    public function updateStatus(Request $request, Loan $loan)
                        ...
                        // {
                        //     dd('Hello from LoanApprovalController');
                        // }
        ...
        public function repaymentSchedule(Loan $loan)
            {
                ...
                if ($loan->repayments()->exists()) {
                    return back()->with('info', 'Repayment schedule already exists.');
                }
                ...
                return back()->with('success', 'Repayment schedule created successfully.');
            }
