...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <!-- Back Button -->
        <div>
            <a href="{{ route('settings.regions.region') }}" class="text-blue-600 hover:underline">&larr; Back</a>
        </div>

        <!-- Form Card -->
        <div class="bg-white p-6 rounded-xl shadow-lg w-full mx-auto overflow-x-auto">

            <h2 class="text-2xl font-bold mb-6 text-center">Register Region</h2>

            <form method="POST" action="{{ route('settings.regions.storeRegion') }}" class="space-y-6">
                @csrf
